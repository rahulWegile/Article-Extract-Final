...
def get_publish_dates(
    ...
    If newspaper is provided, only dates for that
    newspaper are returned.
...
def search_articles(
    ...
    """
    Search or browse newspaper articles.
