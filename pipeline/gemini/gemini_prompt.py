...
# English-routed (OpenAI) grouping only -- Hindi keeps using
# ARTICLE_GROUP_PROMPT above, unchanged. This is a verbatim copy of
# the grouping prompt from the reference "english Pproper" repo: the
# same article-boundary rules, minus the "WHITESPACE GAPS" and
# "MANDATORY COVERAGE AUDIT" sections added later in this repo, which
# the user asked to not carry over for English.
